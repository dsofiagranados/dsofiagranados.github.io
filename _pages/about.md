...
I work with statistical and computational tools for data analysis (Stata, R, ArcGIS, Python) and data collection (SurveyCTO, Twilio for WhatsApp surveys, text mining), and I format my work in LaTeX. I speak Spanish (native), English (advanced), and German (intermediate).
